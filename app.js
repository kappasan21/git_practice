...
app.get('/menu', (req, res) => {
  ...
  if(!res.locals.login) {
    ...
    res.locals.page = "";
    res.locals.message = "Welcome, " + req.cookies.username + "! You can access the menu now.";
    res.render('menu', {
      title: "Menu Page", 
...
app.post('/signup', 
    ...
    pool.query(
      ...
      (error, results) => {
        ...
        if(results.rows.length > 0) {
          ...
          res.locals.message = "Either username or email exists already. Please try with different username and email.";
  ...
  (req, res, next) => {
    ...
    const { username, email, password } = req.body;
    console.log("Server receive a request 2: ", username, " : ", email, " : ", password);
